...
import hookConfig from '../../use-lorem-ipsum/package.json';
...
export default function Index() {
  ...
  const message  = useLoremIpsum("sentences", 1);
  ...
  return (
    <main>
      ...
      <section>
        ...
        <pre>
        <code>
            import useLoremIpsum from use-lorem-ipsum;<br/>
            const words = useLoremIpsum("words", 2);<br/>
            const sentences = useLoremIpsum("sentences", 2);<br/>
